...
export default function Search() {
    ...
    const fetchSearchResults = async (query) => {
        const searchResults = await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${query}&count=10&language=en&format=json`)
        ...
        const updateResults = async () => {
            const cities = await searchResults;
